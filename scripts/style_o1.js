...
var style = { // https://bc61f7f8.bprp.pages.dev/{z}/{x}/{y}.pbf" ]
  "version": 8,
  "name": "Bright",
  "metadata": {
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "tiles": [ "file:///H:/ffmpeg-msvc-build-master/vcpkg-master/cartography/BudapestRoutePlanner/budapest/{z}/{x}/{y}.pbf" ],
      "minzoom": 0,
      "maxzoom": 14
    }
  },
  ...
  "layers": [
    ...
    },
    {
      ...
      "filter": [
		...
		"any",
        ["in", "class", "grass", "farmland"],
        ["in", "subclass", "golf_course", "grassland", "park", "meadow", "garden", "recreation_ground"]
      ]*/,
      "paint": {
        "fill-color": "#d8e8c8",
        "fill-opacity": 1
